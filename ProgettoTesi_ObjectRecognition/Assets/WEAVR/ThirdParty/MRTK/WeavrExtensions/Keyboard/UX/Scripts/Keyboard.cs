...
namespace HoloToolkit.UI.Keyboard
{
    ...
    public class Keyboard : MonoBehaviour
    {
        ...
        public static Keyboard _instance = null;
        ...
        public static Keyboard Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    if (_instance == null)
                    {
                        Debug.Log("Creation of Keyboard singleton object");

                        // If no object is active, then create a new one
                        GameObject go = new GameObject("Keyboard");
                        _instance = go.AddComponent<Keyboard>();
                    }
        ...
        public UnityEvent OnTextSubmittedEvent;
        ...
        public Keyboard DefaultKeyboard;
