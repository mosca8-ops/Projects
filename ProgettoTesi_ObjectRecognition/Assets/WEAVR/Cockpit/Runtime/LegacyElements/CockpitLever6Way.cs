namespace TXT.WEAVR.Cockpit
{
    ...
    [AddComponentMenu("")]
    public class CockpitLever6Way : CockpitLever
    {
        public enum LeverState { STATE_1, STATE_2, STATE_3, STATE_4, STATE_5, STATE_6 }
        ...
        public override void OnPointerUp(PointerEventData eventData) {
            switch (State) {
                ...
                case LeverState.STATE_5:
                    State = _previousState == LeverState.STATE_4 ? LeverState.STATE_6 : LeverState.STATE_4;
                    break;
                case LeverState.STATE_6:
                    State = LeverState.STATE_5;
                    break;
            }
        }
