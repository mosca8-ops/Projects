...
{
    [CustomEditor(typeof(GenericCondition))]
    class GenericConditionEditor : ConditionEditor
    {
        private GenericCondition m_condition;
        ...
        {
            base.OnEnable();
            m_condition = target as GenericCondition;
            m_isComparable = true;
        }
