...
namespace TXT.WEAVR.Controls
{
    ...
    {
        ReorderableList m_Root;
        VisualElement m_Line;

        public LineDragger(ReorderableList root, VisualElement item)
        {
            m_Root = root;
            m_Line = item;
        }
        ...
        protected void OnMouseUp(MouseUpEvent evt)
        {
            ...
            m_Root.EndDragging(m_Ctx, m_Line, listRelativeMouse.y - startPosition.y, mousePosition);
    ...
    class LineSelecter : Manipulator
    {
        ...
        public LineSelecter(ReorderableList root, VisualElement item)
        {
            m_Root = root;
            m_Line = item;
        }
    ...
    public class ReorderableList : VisualElement
    {
        ...
        public void EndDragging(object ctx, VisualElement item, float offset, Vector2 mouseWorldPosition)
        {
            ...
            // TODO: Here the Insert will remove and reassign the panel which will cause a mouse capture release with exception
        ...
        public ReorderableList()
        {
            ...
            Add(m_Toolbar);
            this.AddStyleSheetPath("ReorderableList");
        ...
        public void AddItem(VisualElement item)
        {
            ...
            if (reorderable)
            {
                var dragHandle = AddDragToItem(item);
                //dragHandle.AddManipulator(new LineSelecter(this, dragHandle));
                m_ListContainer.Add(dragHandle);
            }
            else
            {
        ...
        VisualElement AddDragToItem(VisualElement item)
        {
            ...
            //item.AddManipulator(new LineDragger(this, item));

            draggingHandle.Add(item);
            draggingHandle.AddManipulator(new LineSelecter(this, draggingHandle));
            draggingHandle.AddManipulator(new LineDragger(this, draggingHandle));
