...
using BaseClass = Valve.VR.InteractionSystem.BodyCollider;
#else
...
namespace TXT.WEAVR.Interaction
{
    ...
    [AddComponentMenu("WEAVR/VR/Interactions/Body Collider")]
    public partial class VR_BodyCollider : BaseClass
    {
    ...
    public partial class VR_BodyCollider
    {
        [HideInInspector]
        [SerializeField]
    ...
    public partial class VR_BodyCollider : ITargetSerializer
    {
        [NonSerialized]
        ...
        public void Awake()
        {
            ...
            {
                this.GetNonVirtualMethod<BaseClass, VR_BodyCollider>("Awake")();
            }
#endif 
        }
    }
