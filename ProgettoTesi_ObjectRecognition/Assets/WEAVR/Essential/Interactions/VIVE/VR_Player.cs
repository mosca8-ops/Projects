...
using BaseClass = Valve.VR.InteractionSystem.Player;
#else
...
namespace TXT.WEAVR.Interaction
{
    ...
    [AddComponentMenu("WEAVR/VR/Interactions/Player")]
    public partial class VR_Player : BaseClass
    {

    }

#if UNITY_EDITOR && WEAVR_SERIALIZATION
    public partial class VR_Player
    {
        [HideInInspector]
        [SerializeField]
    ...
    [ExecuteInEditMode]
    public partial class VR_Player : ITargetSerializer
    {
        [NonSerialized]
        ...
        public void Awake()
        {
            ...
            {
                this.GetNonVirtualMethod<BaseClass, VR_Player>("Awake")();
            }
#endif 
        }
    }
