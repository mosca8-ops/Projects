...
#if WEAVR_VR
using BaseClass = Valve.VR.SteamVR_Render;
#else
...
namespace TXT.WEAVR.Interaction
{
    ...
    [AddComponentMenu("")]
    public partial class VR_Render : BaseClass
    {
    ...
    public partial class VR_Render
    {
        [HideInInspector]
        [SerializeField]
    ...
    public partial class VR_Render : ITargetSerializer
    {
        [NonSerialized]
        ...
        public void Awake()
        {
            ...
            {
                this.GetNonVirtualMethod<BaseClass, VR_Render>("Awake")();
            }
#endif 
        }
    }
