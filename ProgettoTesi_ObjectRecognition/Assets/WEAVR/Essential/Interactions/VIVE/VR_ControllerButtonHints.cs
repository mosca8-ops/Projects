...
#if WEAVR_VR
using BaseClass = Valve.VR.InteractionSystem.ControllerButtonHints;
#else
...
namespace TXT.WEAVR.Interaction
{
    ...
    [AddComponentMenu("WEAVR/VR/Interactions/Controller Hints")]
    public partial class VR_ControllerButtonHints : BaseClass
    {
    }

#if UNITY_EDITOR && WEAVR_SERIALIZATION

    public partial class VR_ControllerButtonHints
    {
        [HideInInspector]
        [SerializeField]
    ...
    public partial class VR_ControllerButtonHints : ITargetSerializer
    {
        [NonSerialized]
        ...
        public void Awake()
        {
            ...
            {
                this.GetNonVirtualMethod<BaseClass, VR_ControllerButtonHints>("Awake")();
            }
#endif 
        }
    }
