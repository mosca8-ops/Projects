...
namespace TXT.WEAVR.Procedure
{
    ...
    public class TMPTextModifier : BillboardModifier<Text>
    {
        [Serializable]
        private class OptionalFontStyles : Optional<TMPro.FontStyles> { }

        [Serializable]
        private class OptionalTextAlignmentOptions : Optional<TMPro.TextAlignmentOptions> { }
        ...
        private bool m_prevAutoSizing;
        private TMPro.FontStyles m_prevStyle;
        private TMPro.TextAlignmentOptions m_prevAlignment;
        ...
        public override void Prepare(Billboard billboard)
        {
            ...
            m_prevAutoSizing = m_target.enableAutoSizing;
        ...
        public override void FastForward()
        {
            ...
            {
                m_target.enableAutoSizing = m_advanced.bestFit.value;
            }
            if (m_advanced.fontSize.enabled)
            {
        ...
        public override void OnRevert()
        {
            ...
            if (m_advanced.bestFit.enabled)
            {
                m_target.enableAutoSizing = m_prevAutoSizing;
            }
        ...
        private struct AdvancedOptions
        {
            ...
            [Reversible]
            public OptionalAnimatedFloat fontSize;
            [Tooltip("The font style to apply")]
            public OptionalFontStyles fontStyle;
            [Tooltip("The alignment to apply")]
            public OptionalTextAlignmentOptions alignment;
